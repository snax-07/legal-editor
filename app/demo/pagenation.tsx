  ...
  const editor = useEditor({
    ...
    onUpdate: () => {
      ...
      if (editorRef.current) {
        const newPageCount = Math.ceil(editorRef.current.scrollHeight / PAGE_HEIGHT_PX);
  ...
  return (
    <div className="min-h-screen bg-slate-400 py-10 flex flex-col items-center overflow-auto selection:bg-blue-100">
      ...
      <style jsx global>{`
        ...
        .ProseMirror table { border-collapse: collapse; width: 100%; border: 1px solid #cbd5e1; }
        .ProseMirror td, .ProseMirror th { border: 1px solid #cbd5e1; padding: 8px; }

        @media print {
          .fixed { display: none !important; }
          body { background: white !important; padding: 0 !important; }
          .editor-canvas { background-image: none !important; padding: 0 !important; box-shadow: none !important; }
